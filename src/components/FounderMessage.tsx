    ...
    <section className="pt-8 pb-16 relative z-10 w-full mb-8">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="glass-panel border border-white/10 rounded-[2rem] p-8 md:p-12 relative overflow-hidden">
          ...
          <Quote className="text-brand-orange w-12 h-12 mb-6 opacity-50 rotate-180" />
          
          <div className="space-y-6 text-base text-white/80 leading-relaxed font-sans italic">
            <p>
          ...
          <Quote className="text-brand-orange w-12 h-12 mt-6 opacity-50 ml-auto" />

          <div className="border-t border-white/10 pt-6 mt-4 flex flex-col md:flex-row items-start md:items-center gap-6">
